...
<template>
 ...
 <navigator open-type="navigateBack" class="back icon-left" hover-cl
ass="none"></navigator>
 ...
 <picker class="picker" mode="date" start="1900-01-01" :end="new
 Date()" :value="profile?.birthday">
 ...
 <picker class="picker" mode="region" :value="fullLocation?.split
(' ')">
...
.viewport {
 ...
 height: 100%;
 background-image: url(https://pcapi-xiaotuxian-front-devtest.itheima.ne
t/miniapp/images/order_bg.png);
